...
var _tomekwi$present_now_sh$Html_Polymer$paperSwatchPicker = _elm_lang$html$Html$node('paper-swatch-picker');

var _tomekwi$present_now_sh$App$namespace = 'h28dne-';
var _tomekwi$present_now_sh$App$update = F2(
	function (_p1, _p0) {
		return {ctor: '_Tuple0'};
	});
var _tomekwi$present_now_sh$App$model = {ctor: '_Tuple0'};
var _tomekwi$present_now_sh$App$SwatchPicker = {ctor: 'SwatchPicker'};
var _tomekwi$present_now_sh$App$view = function (_p2) {
	var _p3 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace(_tomekwi$present_now_sh$App$namespace);
	var $class = _p3.$class;
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('initial color'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_tomekwi$present_now_sh$Html_Polymer$paperSwatchPicker,
					{
						ctor: '::',
						_0: $class(
							{
								ctor: '::',
								_0: _tomekwi$present_now_sh$App$SwatchPicker,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
...
var _tomekwi$present_now_sh$App$css = {
	ctor: '::',
	_0: A2(
		F2(
			function (x, y) {
		...
		_tomekwi$present_now_sh$App$SwatchPicker,
		{
			ctor: '::',
...
var _tomekwi$present_now_sh$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _tomekwi$present_now_sh$App$model, update: _tomekwi$present_now_sh$App$update, view: _tomekwi$present_now_sh$App$view})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _tomekwi$present_now_sh$Main$main !== 'undefined') {
    _tomekwi$present_now_sh$Main$main(Elm['Main'], 'Main', undefined);
}
...
},{"./defineCustomElement.js":1,"./elm":2}]},{},[3]);
